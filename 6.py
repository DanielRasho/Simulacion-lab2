...
print("bisection roots:", find_all_roots_bisection(f, (-2 , 2), steps=100, tolerance=tol))
print("Secant roots:", find_all_roots_secant(f, (-2 , 2), steps=100, tolerance=tol))
print("Newton roots:", find_all_roots_newton(f, df, (-2 , 2), steps=100, tolerance=tol))